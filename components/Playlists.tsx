    ...
    <section className="space-y-3">
      ...
      <div className="flex flex-wrap gap-2">
        <input
          ...
          className="min-w-0 flex-1 rounded-lg border border-zinc-800 bg-zinc-900 px-3 py-2 text-xs text-white placeholder:text-zinc-500 focus:border-rose-600 focus:outline-none"
        />
        <button
          onClick={() => {
            if (!name.trim()) return;
          ...
          disabled={!name.trim()}
          className="flex items-center gap-1.5 rounded-lg bg-rose-600 px-3 py-2 text-xs font-semibold text-white transition-colors hover:bg-rose-500 disabled:opacity-40"
        >
            ...
            <div key={playlist.id} className="rounded-xl border border-zinc-800 bg-zinc-900/60 p-3">
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="rounded-lg border border-zinc-700 bg-zinc-800 p-2 text-zinc-400 transition-colors hover:text-rose-400"
                >
